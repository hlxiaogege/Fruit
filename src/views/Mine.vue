  ...
  <div class="mine">
    ...
    <div class="mine-body">
      ...
      <div class="order-container">
        <div class="myorder">
          <p>我的订单</p>
          <a  @click="toMyOrder(0)" href="javascript:;">
            <span>查看全部订单</span>
            <img src="../../public/img/arrow-right.png" alt="">
          </a>
        </div>
        <div class="other-order classfix">
          <a @click="toMyOrder(1)" href="javascript:;" class="order-list order1">
            <span class="order-list-img">
              <img src="../../public/img/personal-center-img1.png">
            </span>
            <span class="order-list-text">待付款</span>
          </a>
          <a  @click="toMyOrder(2)" href="javascript:;" class="order-list order1">
            <span class="order-list-img">
              <img src="../../public/img/personal-center-img2.png">
            </span>
            <span class="order-list-text">待发货</span>
          </a>
          <a  @click="toMyOrder(3)" href="javascript:;" class="order-list order1">
            <span class="order-list-img">
          ...
          <a  @click="toMyOrder(0)" href="javascript:;" class="order-list order1">
            <span class="order-list-img">
              <img src="../../public/img/personal-center-img6.png">
            </span>
            <span class="order-list-text">全部订单</span>
          </a>
        </div>
        
      </div>
      <div class="gary-bg"></div>
      <div class="mine-other-list">
        <router-link to="/coupon" class="mine-list-item">
          <img src="../../public/img/arrow-right 3.png">
          <span class="mine-item-img">
            <img src="../../public/img/personal-center-img10.png">
          </span>
          <span>我的优惠券</span>
        </router-link>
        <router-link to="/myaddress" class="mine-list-item">
          <img src="../../public/img/arrow-right 3.png">
          <span class="mine-item-img">
            <img src="../../public/img/personal-center-img11.png">
          </span>
          <span>收货地址</span>
        </router-link>
...
.order-container .myorder{
  padding: 0 1rem;
  display: flex;
  justify-content: space-between;
}
.order-container .myorder p{
  font-size: 0.9rem;
  font-weight: 600;
}
.order-container .myorder a{
  color: #888;
}
.order-container .myorder a img{
  width: 1rem;
  float: right;
}
.other-order{
...
.other-order a span img{
  width: 1.5rem;
}
.other-order a span{
  display: block;
}
.other-order a span:last-child{
  width: 100%;
...
.mine-other-list a span img{
  float: left;
  width: 1.5rem;
  height: 1.5rem;
  margin-top: 0.6rem;
}
.mine-other-list a span:last-child{
  margin-left: 1rem;
}
.mine-other-list a img{
  width: 1.3rem;
  float: right;
  margin-top: 0.6rem;
}
